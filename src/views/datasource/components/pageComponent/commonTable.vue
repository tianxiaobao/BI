<template>
    <div class="s-rightMenu">
        ...
        <div class="border-radius0 bor-box" style="margin-bottom:60px">
            ...
            <table class="listTable table-layout break-word table-striped" v-show="!loading">
                <colgroup>
                    <col width="3%" class="batch">
                    <!-- <col width="25%"> -->
                    <col width="33%">
                ...
                <tbody>
                    ...
                    <tr v-for="item in STobj.data">
                        ...
                        <td class="txtHidden" :title="item.tableName">
                        ...
                        <td>
                            <a href="#" class="blueLink"
                                @click="addToSheet(item.tableName)"
                                >
                                添加至工作表
                            </a>
                            &nbsp;
...
export default {
    ...
    methods: {
        ...
        toggleSubmitList(item) {
            ...
            let index = this.submitList.indexOf(item.tableName);
            if(item.checked) {
