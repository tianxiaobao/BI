$(function(){
	...
	//add20170425 左导航slide
	$(".menu-slide-icon").click(function() {
        if ($(".leftMenu").hasClass("open")) {
            if ($(this).hasClass("close")) {
                $(this).removeClass("close");
                $(".subMenu").animate({left: "0"}, "fast");
                $(".mainCon").animate({"margin-left":"150px"},100);
            }
            else {
                $(".subMenu").animate({left: "-150px"}, "fast");
                $(".mainCon").animate({"margin-left":"0"},100);
                $(this).addClass("close");
            }
        }
        else {
    ...
    $(".spacediv").click(function(){
        if( $(".leftMenu").hasClass("open")){
            ...
            $(".rightCon").animate({"margin-left":"0"},100);
        }
        else{
            $(".leftMenu").addClass("open");
            $(".rightCon").animate({"margin-left":"100px"},100);
        }
    })
...
$(".log-show").mouseleave(function(){
    ...
    $(".nav dt").click(function(){
        $(this).toggleClass("close").siblings("dd").toggle(500);
    });
    ...
    //左侧菜单
    $(".buildCon dt").click(function(){
        $(this).toggleClass("close").siblings("dd").toggle(500);
    });
    $(".buildCon dt").hover(function(){
    	$(this).toggleClass("on");
    });
